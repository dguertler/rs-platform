...
def reaction_window(ohlcv, target_date_str, before=18, after=6):
    """OHLCV-Fenster um den Meldetag für den Reaktions-Chart. Liefert
    (candles, idx) — idx = Position des Meldetags im Fenster (oder None)."""
